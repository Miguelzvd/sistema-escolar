...
export function Login() {
  return (
    <>
        <div className="bg-primary scroll-auto w-full min-h-screen md:h-screen flex flex-col md:flex-row justify-evenly md:justify-between items-center gap-6 md:gap-0">
