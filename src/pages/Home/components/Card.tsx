...
export function Card({ Icon, text, title, Shadowcolor }: Props) {
  return (
    <div className="relative w-full md:w-fit h-72 select-none">
      <div
        className={`absolute inset-1 h-[98%] md:w-[98%] m-auto blur-md animate-pulse opacity-5 ${Shadowcolor}`}
      />
      {/* CARD */}
      <div
        className={
          "relative h-full p-4 bg-[#353536] rounded-lg shadow-2xl cursor-default duration-300"
        }
      >
